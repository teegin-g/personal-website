---
name: goal-eval
description: Use before claiming any non-trivial task done — records an acceptance checklist, runs deterministic gates, and grades work with a fresh judge before completion.
---
